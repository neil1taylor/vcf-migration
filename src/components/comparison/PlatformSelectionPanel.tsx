...
export function PlatformSelectionPanel({ answers, onAnswer, onReset, score }: PlatformSelectionPanelProps) {
  const leaningText =
        ...
        <Column lg={8} md={4} sm={4} style={{ marginTop: '0.5rem' }}>
          <Tile style={{ borderLeft: '4px solid #0f62fe' }}>
            ...
            <p style={{ fontSize: '1.5rem', fontWeight: 600, margin: '0.25rem 0 0' }}>
              {score.vsiCount} of {vsiFactors.length}
            </p>
          </Tile>
        </Column>
        <Column lg={8} md={4} sm={4} style={{ marginTop: '0.5rem' }}>
          <Tile style={{ borderLeft: '4px solid #009d9a' }}>
            ...
            <p style={{ fontSize: '1.5rem', fontWeight: 600, margin: '0.25rem 0 0' }}>
              {score.roksCount} of {roksFactors.length}
            </p>
          </Tile>
        </Column>
